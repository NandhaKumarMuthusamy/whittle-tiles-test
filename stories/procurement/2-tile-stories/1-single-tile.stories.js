...
import Procurement from "../../../src/client/tiles/procurement/components/procurement";

const stories = storiesOf('Procurement | Tile / Single', module);

stories.addDecorator(withKnobs);

const desc = "Procurement";
